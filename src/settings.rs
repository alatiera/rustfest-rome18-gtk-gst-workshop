...
pub struct SettingsDialog {
    container: gtk::Dialog,
    grid: gtk::Grid,
    snapshot_label: gtk::Label,
    snapshot_dir: gtk::FileChooserButton,
    format_label: gtk::Label,
    snapshot_format: gtk::ComboBoxText,
    timer_label: gtk::Label,
    timer_entry: gtk::SpinButton,
    record_dir_label: gtk::Label,
    record_dir: gtk::FileChooserButton,
}
...
impl SettingsDialog {
    ...
    pub fn new(parent: &Option<gtk::Window>) -> Self {
        ...
        SettingsDialog {
            container: dialog,
            grid,
            snapshot_label: snapshot_directory_label,
            snapshot_dir: snapshot_directory_chooser_but,
            format_label,
            snapshot_format,
            timer_label,
            timer_entry,
            record_dir_label: record_directory_label,
            record_dir: record_directory_chooser_but,
        }
    }
}
